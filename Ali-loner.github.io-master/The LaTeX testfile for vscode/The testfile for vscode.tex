...
The $W_{A}$ could be writeen as $\frac{N!}{n!(N-n)!}\cdot\frac{N!}{n!(N-n)!}$, and the $W_{B}$ could be written as $\frac{(2N)!}{(2n)!(2N-2n)!}$ Based on \url{http://hydrogen.physik.uni-wuppertal.de/hyperphysics/hyperphysics/hbase/math/stirling.html} the general form of sterling approximation could is $n! \approx n^{n}e^{-n}\sqrt{2 \pi n}$, So the ratio between $W_{A}$ and $W_{B}$ could be calculated through:
\begin{equation}
	\frac{W_{B}}{W_{A}}=\frac{(2N)!}{(2n)!(2N-2n)!}\cdot \frac{n! n!}{(2n)!}\cdot \frac{(N-n)!(N-n)!}{(2N-2n)!}
\end{equation}
We could use $\frac{N!N!}{(2N)!}$ as an example:
\begin{equation}
	\frac{N^{N}e^{-N}\sqrt{2 \pi N} N^{N} e^{-N}\sqrt{2 \pi N}}{(2N)^{2N}e^{-2N}\sqrt{4 \pi N}}=\frac{\sqrt{\pi N}}{4^{N}}
\end{equation}
So the second term is $\frac{4^{n}}{\sqrt{\pi n}}$ and the third term is $\frac{4^{N-n}}{\sqrt{\pi (N-n)}}$. 
\newline
So the result is $\frac{W_{B}}{W_{A}}=\sqrt{\frac{N}{\pi n(N-n)}}$
